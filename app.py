...
LAST_DATA_UPDATE = "August 2, 2026" 
...
with st.sidebar:
    ...
    data = {
        ...
        "Jan 31-Feb 1": [8.29, 11.16, 16.35, 13.21, 8.43, 9.56, 17.92, 7.8, 7.31, 7.0, 5.82, 6.5, 12.33],
        "Feb 14-15": [7.47, 9.11, 13.52, 8.97, 7.29, 10.2, 11.23, 15.0, 8.64, 4.88, 7.14, 4.5, 13.67],
        "Feb 21-22": [12.27, 9.80, 22.13, 5.60, 7.83, 14.81, 16.33, 9.00, 8.19, 5.67, 3.75, 3.50, 10.00],
        "Feb 28-Mar 1": [3.95, 10.00, 11.66, 17.19, 8.09, 9.54, 14.76, 9.67, 8.97, 8.29, 5.25, 7.0, 8.33],
        "Mar 7-8": [3.67, 12.76, 11.59, 12.28, 7.15, 9.27, 11.21, 8.25, 6.56, 5.0, 2.43, 3.0, 7.0],
        "Mar 14-15": [4.5, 10.19, 7.59, 8.89, 6.43, 9.0, 10.58, 9.86, 4.74, 3.0, 4.2, 12.5, 8.08],
        "Mar 21-22": [5.55, 12.53, 11.06, 14.88, 6.05, 6.68, 11.42, 6.8, 7.63, 2.75, 4.45, 3.0, 6.17],
        "Mar 27-28": [8.00, 11.06, 8.50, 7.16, 7.54, 7.03, 5.95, 12.57, 5.95, 2.25, 4.29, 6.00, 7.6],
        "Apr 4-5": [8.5, 5.96, 33.38, 9.41, 6.77, 8.06, 15.89, 5.0, 6.29, 0, 1.0, 0, 8.67],
        "Apr 11-12": [6.0, 10.7, 8.46, 7.95, 9.28, 9.26, 12.75, 10.10, 7.61, 4.13, 3.20, 2.0, 8.5],
        "Apr 18-19": [3.18, 9.76, 7.67, 10.83, 10.33, 6.61, 11.6, 5.78, 5.77, 3.4, 4.8, 0, 5.0],
        "Apr 25-26": [4.21, 12.46, 8.80, 11.24, 8.28, 10.14, 15.59, 7.60, 5.92, 4.00, 2.33, 2.50, 4.50],
        "May 9-10": [12.79, 11.05, 9.17, 8.04, 8.00, 6.44, 6.14, 4.84, 4.00, 3.50, 2.60, 2.00, 1.43],
        "May 16-17": [2.44, 11.24, 21.63, 10.07, 8.69, 5.61, 9.25, 15.62, 3.78, 7.29, 6.20, 1.0, 19.2],
        "May 23-24": [5.6, 10, 17.59, 8.7, 5.43, 6.79, 15.8, 8.0, 4.5, 10, 0, 0, 8.0],
        "May 30-31": [6.17, 9.36, 12.81, 6.35, 6.44, 6.04, 5.82, 7.57, 2.59, 5.6, 1.33, 2.0, 4.0],
        "June 6-7": [8.71, 6.17, 18.05, 11.9, 5.82, 5.72, 13.04, 10.56, 4.0, 2.33, 3.0, 2.0, 11.25],
        "June 13-14": [5.89, 10.53, 7.81, 8.76, 5.35, 6.67, 7.94, 7.83, 3.62, 2.50, 5.0, 2.0, 3.75],
        "June 20-21": [2.31, 10.58, 10.96, 8.53, 5.17, 7.16, 8.15, 7.0, 3.42, 3.0, 2.0, 0.0, 2.65],
        "June 27-28": [2.13, 8.64, 11.52, 6.04, 7.25, 5.42, 7.19, 7.75, 2.57, 3.14, 3.4, 1.0, 1.5],
        "July 4-5": [12.0, 8.45, 11.14, 7.64, 9.55, 9.45, 4.6, 7.25, 2.53, 1.0, 3.5, 14.0, 4.5],
        "July 11-12": [5.47, 9.88, 11.59, 6.86, 6.06, 5.93, 6.23, 6.5, 2.05, 4.47, 4.5,0.0, 10.83],
        "July 18-19": [1.18, 7.68, 5.77, 7.65, 5.18, 5.07, 8.92, 2.89, 2.38, 3.33, 2.00, 0.00, 0.00],
        "July 25-26": [5.58, 8.10, 13.62, 5.28, 5.21, 4.47, 6.53, 3.89, 3.06, 3.88, 6.00, 12.50, 2.67],
        "Aug 1-2": [6.68, 8.58, 7.11, 7.78, 4.52, 6.22, 6.77, 6.20, 3.00, 2.71, 3.33, 4.00, 8.75],
        "Aug 8-9": [2.74, 9.64, 8.09, 5.66, 5.74, 6.21, 6.04, 5.85, 2.22, 7.08, 4.67, 4.50, 4.58],
        "Aug 15-16": [5.33, 10.28, 8.15, 7.10, 4.45, 6.43, 8.58, 4.45, 2.67, 5.00, 5.67, 5.00, 2.57],
        "Aug 22-23": [1.86, 7.24, 5.19, 8.48, 4.22, 4.82, 5.85, 3.44, 4.51, 6.25, 3.00, 10.50, 6.92],
    }
