...
with st.sidebar:
    ...
    data = {
        ...
        "Feb 14-Feb 15": [7.47, 9.11, 13.52, 8.97, 7.29, 10.2, 11.23, 15.0, 8.64, 4.88, 7.14, 4.5, 13.67],
        "Feb 21-Feb 22": [12.27, 9.80, 22.13, 5.60, 7.83, 14.81, 16.33, 9.00, 8.19, 5.67, 3.75, 3.50, 10.00],
        "Feb 28-Mar 1": [3.95, 10.00, 11.66, 17.19, 8.09, 9.54, 14.76, 9.67, 8.97, 8.29, 5.25, 7.0, 8.33],
        "Mar 7-Mar 8": [3.67, 12.76, 11.59, 12.28, 7.15, 9.27, 11.21, 8.25, 6.56, 5.0, 2.43, 3.0, 7.0]
    }
